...
class ReporteExport_4 implements FromView, WithTitle, WithEvents
{
    private $data;
    ...
    public function view(): View {
        return view('adblue.reportes.excel.vw_rep_datos_prom_general_ex4', [
            'datos' => $this->data
        ]);
    }
    ...
    {
        return 'COSTO OPTIMO GEN. ABAST. RUTA';
    }
    ...
    public function registerEvents(): array {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('A1:H2')->applyFromArray($styleArray)->getAlignment();
