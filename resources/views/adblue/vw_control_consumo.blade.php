    ...
    jQuery(document).ready(function ($) {
        ...
        jQuery("#tblcontrol_consumo").jqGrid({
            ...
            colModel: [
                ...
                {name: 'xcde_conductor', index: 'xcde_conductor', align: 'left', width: 320},
                {name: 'xcde_copiloto', index: 'xcde_copiloto', align: 'left', width: 320},
                {name: 'xcde_ruta', index: 'xcde_ruta', align: 'center', width: 70},
                {name: 'xcde_qabastecida', index: 'xcde_qabastecida', align: 'center', width: 90},
