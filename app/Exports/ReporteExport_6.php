...
class ReporteExport_6 implements FromView, WithTitle, WithEvents
{
    private $data;
    ...
    public function view(): View {
        return view('adblue.reportes.excel.vw_rep_datos_prom_general_ex6', [
            'datos' => $this->data
        ]);
    }
    ...
    {
        return 'COSTO GENERAL ABAST. PLACA';
    }
    ...
    public function registerEvents(): array {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('A1:F2')->applyFromArray($styleArray)->getAlignment();
