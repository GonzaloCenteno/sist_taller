...
<html lang="en">
    <head>
        ...
        <title>DATOS GENERALES POR PLACA</title>
                ...
                <td style="width: 80%; padding-top: 0px; border:0px;">
                    <div id="details" class="sub2">
                        <div id="invoice" style="font-size:1em" >
                            <h1>DATOS GENERALES POR PLACA : SCANIA</h1>
                        </div>
            ...
            <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom:20px; margin-top: 0px;  font-size: 1.0em;">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" style="width: 15%;">SCANIA</th>  
                        <th colspan="5" style="width: 80%;">DATOS GENERALES POR PLACA</th>  
                    </tr>
                </thead>
                <thead>
                    <tr>   
