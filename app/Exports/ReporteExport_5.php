...
class ReporteExport_5 implements FromView, WithTitle, WithEvents
{
    private $data;
    ...
    public function view(): View {
        return view('adblue.reportes.excel.vw_rep_datos_prom_general_ex5', [
            'datos' => $this->data
        ]);
    }
    ...
    {
        return 'COSTO GENERAL ABAST. RUTA';
    }
