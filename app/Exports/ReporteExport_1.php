...
class ReporteExport_1 implements FromView, WithTitle, WithEvents {
    ...
    public function view(): View {
        return view('adblue.reportes.excel.vw_rep_datos_prom_general_ex1', [
            'datos' => $this->data
        ]);
    }
    ...
    public function title(): string {
        return 'PROMEDIOS GENERALES - RUTA';
    }
    ...
    public function registerEvents(): array {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('A1:I2')->applyFromArray($styleArray)->getAlignment();
